...
if __name__ == '__main__':
    ...
    """
    torch.Size([1, 116, 40, 40])
    torch.Size([1, 232, 20, 20])
    torch.Size([1, 464, 10, 10])

    """
    model=PAN([116,232,464],96,3)

    print (model)


    a=torch.randn([1, 116, 40, 40])
    b=torch.randn([1, 232, 40, 40])
    c=torch.randn([1, 464, 40, 40])
    data=[a,b,c]
